...
Route::get('/auth/socialite/redirect/{provider}', [AuthenticatedSessionController::class, 'redirectToProvider'])
    ->middleware('guest')
    ->name('login.with.socialite');

Route::get('/auth/socialite/callback/{provider}', [AuthenticatedSessionController::class, 'handleProviderCallback'])
    ->middleware('guest')
    ->name('login.with.socialite.callback');