                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse " id="sidebarAnalytics">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a href="{{ route('second', ['application', 'analytics-customers'])}}" class="nav-link ">Clientes</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('second', ['application','analytics-reports'])}}" class="nav-link ">Agendamentos</a>
                                </li>
                            </ul>
                        </div>
                    </li>
