<div class="topbar d-print-none">
    <nav class="topbar-custom d-flex justify-content-between px-4" id="topbar-custom">
        ...
        <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
            ...
            <li class="mx-3 welcome-text">
                <h3 class="mb-0 fw-bold text-truncate">{{ $title ?? 'JuliaBraids' }}</h3>
        ...
        <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
            ...
            <li class="dropdown topbar-item">
                ...
                <div class="dropdown-menu stop dropdown-menu-end dropdown-lg py-0">
                    ...
                    <!-- All-->
                    <a href="{{ route('second', ['pages', 'notifications'])}}" class="dropdown-item text-center text-dark fs-13 py-2">
